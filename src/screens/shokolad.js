...
import { AsyncStorage, FlatList, Image, ScrollView, StyleSheet, Text, TouchableOpacity,TextInput, View } from 'react-native';
...
export default class shokolad extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        database.ref('/products/חלבי/שוקולדים').on('value', querySnapshot => {
